...
def modified_player(request):
    ...
    recv = totalModifyPlayerData(serverip, player_id, flag, marble_change, goldcoin_change, energy_change, ticket, lvl_change, exp_change, present_point_change, point_change, deleteCardid)
...
def refreshfriend(request):
    dict1 = {}
    template = "richman/refreshfriend.html"
    return render_to_response(template, dict1)
